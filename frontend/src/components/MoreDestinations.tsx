  ...
  useEffect(() => {
    const fetchAllTrips = async () => {
      try {
        ...
        // Fix: Set allTrips and groupTrips to show ALL trips initially
        setAllTrips(data);
        setGroupTrips(data);
      } catch (error) {
        ...
        {selectedPackage && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
            <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
              ...
              <p>
                <strong>Travel Type:</strong> {selectedPackage.travelType}
              </p>
              <p className="mt-4">
              ...
              <div className="flex justify-between">
                ...
                <Link
                  to="/contact"
                  className="mt-4 bg-blue-600 text-white px-4 py-2 rounded-lg shadow-md hover:bg-blue-700 transition-all text-sm"
                >
                  Contact Us
                </Link>
              </div>
